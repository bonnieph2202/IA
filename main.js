...
var pcscore =0;
//Posiciones X y Y de la bola, velocidad X y Y, y radio
var ball = {
    x:350/2,
    y:480/2,
    r:20,
...
{
  game_status = "start";
  document.getElementById("status").innerHTML = "El juego se cargó";
}
...
if(game_status == "start")
{
  ...
  if(scoreRightWrist > 0.2)
  {
    ...
    //Llama a la funcipon paddleInCanvas 
    paddleInCanvas();
...
//Llama a la función reset cuando la pelota no entre en contacto con la paleta
function reset(){
   ball.x = width/2+100,
   ball.y = height/2+100;
   ball.dx=3;
